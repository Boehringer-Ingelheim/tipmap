...
A few additional specifications are needed to be made to fit the MAP prior model; for details see Neuenschwander and @Schmidli2020 or @Weber2021. The variable `uisd` here represents an assumed unit-information standard deviation and the specification of the prior on between-trial heterogeneity parameter tau follows recommendations to consider moderate heterogeneity for a two-group parameter, such as the mean difference (@Neuenschwander2020).
